...
\subsection*{Overview of tskit's functionality}
To give a sense of the breadth of functionality provided by tskit,
Table S2 enumerates representative operations grouped into eight
broad categories that mirror the structure of the tskit API.
...
libraries that target adjacent niches:
ARGneedle-lib\citesupp{zhang2023biobank}, which infers and analyses
ancestral recombination graphs from biobank-scale data;
matUtils\citesupp{mcbroome2021matutils}, part of the Big Tree Editor
(BTE) toolkit for manipulating mutation-annotated trees of
SARS-CoV-2;
and DendroPy\citesupp{sukumaran2010dendropy}, a long-established
general-purpose phylogenetic scripting library.
For each operation we mark whether the comparison library offers a
comparable feature: \checkmark{} denotes full support, $\circ$
denotes partial or restricted support, and a blank cell denotes
none. The list is illustrative rather than exhaustive and reflects
library state at the time of writing.

\input{functionality_table.tex}

\bibliographystylesupp{naturemag}
\bibliographysupp{paper}
